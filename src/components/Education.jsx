...
const Education = () => {
  ...
  return (
    <section className='text-white py-20 pt-28 overflow-hidden' id='education'>
        <div className='max-w-7xl mx-auto px-6 lg:px-16'>
            ...
            <div className='flex flex-col lg:flex-row items-center gap-16'>
                <div className='w-full lg:w-5/12 flex justify-center lg:justify-start' data-aos='fade-right'>
                    <div className='relative'>
                        ...
                        <div className='relative z-10 bg-[#111a3e] rounded-2xl overflow-hidden border border-[#1f1641]'>
                            ...
                            className='w-[500px] h-[650px] md:w-96 md:h-[650px] object-cover transform transition-transform duration-500 hover:scale-110'
                            />
                        </div>
                ...
                {educationData.map((edu) => (
                    <div key={edu.id}
                    className='group relative p-6 rounded-2xl bg-[#111a3e] border border-[#1f1641] transition-all duration-200 hover:border-primary/50'>
